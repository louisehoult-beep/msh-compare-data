    ...
    function compare(mine, theirs, angle, edge, typedMine, chosenSupMine, typedTheirs, chosenSupTheirs, autoSuggested){
      ...
      if (saveAnnual != null){
        ...
        var snote = saveAnnual > 0
          ...
          : 'Do not lead on price. Lead on the value side value-based procurement actually scores — training, implementation support, resilience, outcomes (the five value domains carry a minimum 60% combined; whole-life cost should carry a maximum 40%) — and build the number in the Value Case Calculator. Verify both prices on the live catalogue first.';
      ...
      var DRIVERS = [
        ...
        {n:'Value-based procurement scoring', ev:'DHSC national standard: five value domains carry a minimum 60% combined weighting, of which social value is at least 10%; whole-life cost should carry a maximum weighting of 40%. A framework provider that deviates must present its rationale. Better-value challengers can beat cheaper incumbents.', src:'https://www.gov.uk/government/publications/value-based-procurement-for-medical-technology',
